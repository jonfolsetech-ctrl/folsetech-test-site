...
export const metadata: Metadata = {
  title: "AI Web Design & SEO in New Orleans, Louisiana | Folsetech AI Solutions LLC",
  description: "Folsetech AI Solutions LLC provides AI-powered web design and full SEO integration for businesses in New Orleans, Louisiana. High-performance websites engineered to rank on Google.",
  keywords: ["AI web design New Orleans LA", "SEO New Orleans Louisiana", "web design New Orleans", "local SEO New Orleans"],
};

export default function NewOrleansPage() {
  return (
    <>
      <LocalJsonLd city="New Orleans" citySlug="new-orleans-louisiana" />
      <Navigation />
      
      <section className="px-4 md:px-6 py-16 md:py-24 bg-gradient-to-b from-slate-900 to-blue-900">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            AI Web Design & SEO in New Orleans, Louisiana
          </h1>
        </div>
      </section>
      ...
      <section className="px-4 md:px-6 py-12 md:py-16 max-w-4xl mx-auto">
        <div className="prose prose-lg max-w-none">
          <p className="text-slate-700 leading-relaxed mb-6">
            Folsetech AI Solutions LLC provides AI-powered web design and full SEO integration for businesses in New Orleans, Louisiana. We build high-performance websites engineered to rank on Google, attract qualified traffic, and convert visitors into customers.
          </p>
          ...
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Services in New Orleans Include:</h2>
          <ul className="space-y-3 mb-6">
            ...
            <li className="flex gap-3 items-start">
              <span className="text-amber-500 font-bold">✓</span>
              <span className="text-slate-700">Local SEO optimization for New Orleans searches</span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="text-amber-500 font-bold">✓</span>
